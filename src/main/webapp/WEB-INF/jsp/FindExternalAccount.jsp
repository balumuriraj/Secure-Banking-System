...
<h3 style="text-align:center;">Customers Account Management</h3>
...
<p style="text-align:center;">Go Back to <a class="myButton" href="/SecureOnlineBanking/externalUsersAccounts">Customers Account Management</a></p><%@ include file="footer.jsp"%>