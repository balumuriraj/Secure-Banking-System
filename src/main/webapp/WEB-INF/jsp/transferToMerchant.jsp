...
<div
	...
	<div style="padding: 10px 30px 10px 30px;">
		...
		<div>
			...
			<form:form method="post" action="transferMerchantTransaction.html">
				...
				<table>
					...
					<tr>
						<td><form:label path="transDetail">Merchant's Username</form:label></td>
						<td><form:input path="transDetail" /></td>
					</tr>
					<tr>
						<td><form:label path="amountInvolved">Amount To Tranfer </form:label></td>
						<td><form:input path="amountInvolved" /></td>
					</tr>
					<tr>
						<td></td>
