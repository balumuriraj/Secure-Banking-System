	...
	<div style="padding: 10px 30px 10px 30px;">
		...
		<div style="">
			...
			<form:form method="post" modelAttribute="internalTransaction"
				action="/SecureOnlineBanking/ITRegularEmployee/updateInternalUserTransaction.html">
				...
				<table>
					...
					<tr>
						...
						<td><b>${internalTransaction.employeeId}</b></td>
					</tr>
					<tr>
						<td><form:label path="transType">Transaction Type</form:label></td>
						<td><form:input path="transType" readonly="true"
								value="IT Support" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td></td>
						<td><input type="submit" value="Update Ticket"
							class="myButton"></td>
					</tr>
				</table>
