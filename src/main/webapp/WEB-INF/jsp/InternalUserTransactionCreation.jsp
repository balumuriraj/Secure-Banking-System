...
<form:form method="post" model="command" action="/SecureOnlineBanking/transactionMonitoringEmployee/addInternalUserTransaction.html">
 ...
 <table>
    ...
    <tr>
        <td colspan="2">
            <input type="submit" value="Create Internal Transaction">
        </td>
    </tr>
</table> 
