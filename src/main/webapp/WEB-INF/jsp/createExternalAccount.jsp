...
<div>
	<div>
		<h3 class="heading">Registration Form (External)</h3>
		<form:form method="post" modelAttribute="user">
			...
			<table class="regform">
				...
				<tr>
					<td></td>
					<td><form:checkbox style="width: 20px; height: 12px;" path="checkbox"
						id="conditions" value="true" /><label
						style="line-height: 12px;" for="conditions">I accepts
							terms and conditions here</label></td>
				</tr>
				<tr>
				<td></td>
				<td><p style="font-size:10px;">I hereby agree to provide authorization to Bank Official access to my account and my transactions.</p></td>
				</tr>
				<tr>
					<td></td>
