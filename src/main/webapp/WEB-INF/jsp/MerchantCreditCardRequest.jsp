...
<h3 style="text-align:center;">Credit Card Request</h3>
...
<table id="tfhover" class="tftable" border="1">
	<thead>
		<tr>
			...
			<th>CREDIT CARD REQUEST APPROVED</th>
		</tr>
	</thead>
	<tbody>
			<tr>
				<td>${creditCard.accountNo}</td>
				<td>${creditCard.approved}</td>
...
<p style="text-align:center;">Go Back to <a class="myButton" href="/SecureOnlineBanking/Merchant">Merchant Home Page</a></p>
