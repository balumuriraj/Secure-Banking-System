...
<div
	...
	<div style="padding: 10px 30px 10px 30px;">
		...
		<div>
			...
			<form:form method="post" modelAttribute="credit"
				action="creditMerchantTransaction.html">
				...
				<table>
					...
					<tr>
						<td><form:label path="amountInvolved">Amount To Credit </form:label></td>
						<td><form:input path="amountInvolved" type="number"/></td>
					</tr>
					<tr>
						<td></td>
						<td><input type="submit" value="Credit Money"
							onClick="getValue()" class="myButton"></td>
					</tr>
				</table>
