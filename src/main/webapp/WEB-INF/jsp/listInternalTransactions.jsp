...
<h3 style="text-align:center;">List of Internal User Transactions</h3>
	...
	<tbody>
		<c:forEach var="item" items="${transactions}">
			<tr>
			    ...
			    <td>${item.status}</td>
			     <td>   &nbsp;<a href="updatetransaction?transId=${item.transId}">Update</a></td>
				 <td> &nbsp;&nbsp;<a href="deletetransaction?transId=${item.transId}">Delete</a></td>
