...
<div style="width: 900px; margin: 0 auto; background:#fff; box-shadow: 0 1px 5px #000;">
	<div style="padding: 10px 30px 10px 30px;">
		...
		<div>
			...
			<form:form method="post" modelAttribute="transaction" action="/SecureOnlineBanking/ITRegularEmployee/findInternalTransaction">
				<table>
					<tr>
		...
		<div style="text-align: center;">
			<div
				...
				<a class ="myButton" href="displaytransactions">Display IT Dept Transactions </a>
			</div>
			<div
				style="text-align: center; padding: 20px; display: inline-block;">
				<a class ="myButton" href="ITInternalUserTransaction">Add IT Dept User Transaction</a>
			</div>
		</div>
	</div>
</div>
