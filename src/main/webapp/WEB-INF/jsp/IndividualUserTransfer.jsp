...
<div
	...
	<div style="padding: 10px 30px 10px 30px;">
		...
		<div>
			...
			<form:form method="post" modelAttribute="transfer"  action="transferTransaction.html">
			<c:if test="${not empty errors}">
				...
				<table>
					...
					<tr>
						<td><form:label path="transDetail">Account Number To Transfer </form:label></td>
						<td><form:input path="transDetail" type="number" /></td>
					</tr>
					<tr>
						<td><form:label path="amountInvolved">Amount To Tranfer </form:label></td>
						<td><form:input path="amountInvolved" type="number" /></td>
					</tr>
					<tr>
						<td></td>
						<td><input type="submit" value="Transfer Money" class="myButton">
						</td>
					</tr>
				</table>
